...
#include <memory>
#include "../QEventLoop0/workerthread.h"
...
QT_MOC_LITERAL(4, 34, 8) // "finished"
    ...
    "WorkerThread\0progress\0\0percentage\0"
    "finished"
};
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (WorkerThread::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::progress)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::finished)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void WorkerThread::progress(int _t1)
{
